    ...
    <section className="relative py-20 bg-black text-white overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-5xl font-bold bg-gradient-to-r from-[#ff99cc] to-[#ff66b3] text-transparent bg-clip-text mb-4">
        ...
        <div className="relative">
          ...
          <motion.div 
            ...
            className="absolute left-1/2 transform -translate-x-1/2 h-full w-0.5 bg-gradient-to-b from-[#ff99cc]/30 to-transparent"
          ></motion.div>
          ...
          <div className="space-y-16">
            {timelineData.map((item, index) => (
              ...
              >
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 w-6 h-6 rounded-full bg-[#ff99cc] 
                  animate-ping-slow z-20"></div>
                <div className="absolute left-1/2 transform -translate-x-1/2 w-4 h-4 rounded-full bg-[#ff99cc] z-30"></div>

                {/* Content card with hover effect */}
                <div className={`w-[calc(50%-2rem)] group ${
                  index % 2 === 0 ? 'pr-8' : 'pl-8'
                }`}>
                  <div className="bg-gray-900/50 rounded-xl p-6 backdrop-blur-sm border border-[#ff99cc]/10 
                    transition-all duration-300 group-hover:scale-[1.02] group-hover:shadow-2xl 
                    group-hover:shadow-[#ff99cc]/20">
                    <h3 className="text-[#ff99cc] font-medium mb-1 transition-colors group-hover:text-[#ff66b3]">
                      {item.title}
                    </h3>
                      ...
                      <ul className="space-y-2">
                        {item.achievements.map((achievement, i) => (
                          <li key={i} className="text-gray-400 text-sm flex items-start 
                            ...
                            <span className="w-1.5 h-1.5 rounded-full bg-[#ff99cc] mt-1.5 mr-2 flex-shrink-0"></span>
                            {achievement}
                          </li>
                        ))}
                      </ul>
                      ...
                      <div className="space-y-3 mt-4">
                        ...
                        {item.projects.map((project, i) => (
                          <div key={i} className="text-sm">
                            <p className="text-[#ff99cc] group-hover:text-[#ff66b3] transition-colors">
                              {project.name}
                            </p>
